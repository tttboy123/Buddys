...
export BUDDYS_DEFAULT_TOKEN_PLAN_KEY="${BUDDYS_DEFAULT_TOKEN_PLAN_KEY:-${BUDDYSDEFAULTTOKENPLANKEY:-}}"
...
export MINIMAX_TOKEN_PLAN_KEY="${MINIMAX_TOKEN_PLAN_KEY:-${MINIMAXTOKENPLANKEY:-}}"
